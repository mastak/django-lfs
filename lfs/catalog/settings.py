...
PRODUCT_ACTIVE_DEFAULT = getattr(settings, 'LFS_PRODUCT_ACTIVE_DEFAULT', False)
PRODUCT_ACTIVE_IMAGES_DEFAULT = getattr(settings, 'LFS_PRODUCT_ACTIVE_IMAGES_DEFAULT', False)
